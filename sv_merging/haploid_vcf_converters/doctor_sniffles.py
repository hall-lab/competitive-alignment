...
def add_arguments_to_parser(parser):
    ...
    parser.add_argument('-p', '--haplotype', dest='haplotype', required=False, help='dummy')
    parser.add_argument('-r', '--parent', dest='parent', required=False, help='dummy')
  ...
  with su.InputStream(args.manta_vcf) as input_stream:
    for line in input_stream:
      if in_header:
        ...
        ll[2]=args.caller+'.diploid_'+ll[2]
        v = Variant(ll, vcf)
